...
- [ ] mac-property-reconstruction - Build a rough 3D property tour with fixed 360 stations (since 2026-09-09)
  ...
  Implemented: direct image import, rough mesh export and a working source-camera viewer.
  ...
  Next: clean the selected navigation mesh, export fixed panorama stations and build the tour view.
  FixAnything source is now cloned locally for MPS feasibility work.
